...
public class MergeBitmap {
    ...
    public  static Bitmap mergeBitmap(Bitmap bitmap1,Bitmap bitmap2,boolean LR){
        if(LR)  return mergeBitmap_LR(bitmap1,bitmap2,true);
        return mergeBitmap_TB(bitmap1,bitmap2,true);
    }
